class UserSessionController < ApplicationController
  ...
  def post_to_facebook()
   ...
   if params[:quote_id]
      ...
      url = "https://graph.facebook.com/me/feed?access_token=#{uri_escape(session[:access_token])}&message=#{uri_escape(quote.quote)}&link=#{link}&caption='Posted via QuotesApp'"
      r = RestClient.get url
